...
roleObjAdmin.permissions = permissionsAdmin
roleObjUser.permissions = permissionsUser
roleObjWorker.permissions = permissionsWorker
const infoRoleUser = {
...
infoRoleAdmin.role = roleObjAdmin
infoRoleUser.role = roleObjUser
infoRoleWorker.role = roleObjWorker
...
var infoRoleAdminB = builder(infoRoleAdmin)
var infoRoleUserB = builder(infoRoleUser)
var infoRoleWorkerB = builder(infoRoleWorker)
console.log('inforoleAdmin', infoRoleAdminB)
console.log('inforoleUser', infoRoleUserB)
console.log('inforoleWorker', infoRoleWorkerB)
const info = options => {
  ...
  // console.log('user info', userInfo, 'userinfo role', userInfo.role)
...
// info()
// console.log(info().result.role.permissions)
